      ...
      <div class="row align-items-center">
        <div class="col-12 col-sm-6">
          <div class="hero-content">
            ...
            <a class="event-btn" href="{{ route('register') }}"><i class="fa fa-users"></i> Become a member</a>
          </div>
        </div>
            ...
            <div class="carousel-item col-md-4 col-15 active">
              <div class="card event-card">
                <div class="card hovercard">
                  ...
                  <div class="avatar">
                    <img src="{{ asset('images/frontend/team/johnmbiya.jpg') }}" alt="mentor avatar">
                  </div>
                  <div class="info">
                    <div class="title">
                      <h5>Jean Claude Mbiya</h5>
                      <p>Co - Lead</p>
                    </div>
                  ...
                  <div class="bottom">
                    <ul class="social-list__inline mt-10">
                      <li>
                        <a href="https://twitter.com/johnmbiya" target="_blank" rel="noopener">
                          <i class="fab fa-twitter"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://github.com/johnwalterjobs" target="_blank" rel="noopener">
                          <i class="fab fa-github"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://www.linkedin.com/in/jeanclaudembiya" target="_blank" rel="noopener">
            ...
            <div class="carousel-item col-md-4 col-15">
              <div class="card event-card">
                <div class="card hovercard">
                  <div class="cardheader"></div>
                  <div class="avatar">
                    <img src="{{ asset('images/frontend/team/lead.png') }}" alt="lead avatar">
                  </div>
                  <div class="info">
                    <div class="title">
                      <h5>Kanyinda Grace OLivier</h5>
                      <p>Lead Organizer</p>
                    </div>
                    <div class="desc">Mobile, and web developer</div>
                    <div class="desc">Open source enthusiast</div>
