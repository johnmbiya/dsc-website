        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="footer-widget">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="https://github.com/dscunikin" target="_blank" rel="noreferrer">File a bug</a>
                </li>
                <li>
                  <a href="https://github.com/dscunikin" target="_blank" rel="noreferrer">View source</a>
                </li>
                <li>
